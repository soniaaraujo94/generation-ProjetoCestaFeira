...
//        produtoSelecionado = viewModel.produtoSelecionado
 //       if (produtoSelecionado != null) {
   //         binding.nomeProduto.text = produtoSelecionado?.nomeMarca
     //       binding..text = produtoSelecionado?.descricao
    //        Glide.with(this).load(produtoSelecionado?.imagem).placeholder(R.drawable.bg_produto).into(binding.produtoImagem)
